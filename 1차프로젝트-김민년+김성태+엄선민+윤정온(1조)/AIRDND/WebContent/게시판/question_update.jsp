<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	String question_contents = request.getParameter("contents"); 
	%>
<!DOCTYPE html>
<html>
<head>
	...
	<div class=create>
		...
		<form action="question_updateDB.jsp">
			...
			<br> <span class=titlec>- 제&nbsp;&nbsp; 목
				...
				placeholder="    <%=question_title%>" name="question_title"> <br><br>
			<br> <span class=contentsc>- 내&nbsp;&nbsp; 용 </span><br><br>
			<textarea rows="10" cols="50" name="question_contents"><%=question_contents%></textarea>
